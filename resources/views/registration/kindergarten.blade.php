...
<div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    <div class="bg-white shadow-xl rounded-lg overflow-hidden">
        <div class="bg-gradient-to-r from-pink-600 to-purple-600 px-6 py-8">
            <h2 class="text-3xl font-bold text-white text-center">
                {{ __('Kindergarten Registration') }}
            </h2>
        ...
        <form method="POST" action="{{ route('register.kindergarten.store') }}" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="name" class="block text-sm font-medium text-gray-700 mb-2">
                            {{ __('Kindergarten Name') }} <span class="text-red-500">*</span>
                        </label>
            ...
            <div class="bg-gray-50 p-6 rounded-lg">
                <h3 class="text-lg font-semibold text-gray-900 mb-4">{{ __('Kindergarten Details') }}</h3>
                ...
                <div class="mb-6">
                    ...
                    <textarea id="description" name="description" rows="4" required
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="flex justify-center pt-6">
                <button type="submit" 
                        class="bg-gradient-to-r from-pink-600 to-purple-600 text-white px-8 py-3 rounded-lg font-semibold hover:from-pink-700 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2 transform transition hover:scale-105">
