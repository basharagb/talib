    ...
    <form method="POST" action="{{ route('register.teacher.store') }}" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="form-section p-6 mb-8">
            <div class="flex items-center mb-6">
                <div
                    class="w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center mr-4">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                    </svg>
                </div>
                <h3 class="text-2xl font-bold text-gray-900">{{ __('messages.Basic Information') }}</h3>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-700 mb-2">
                        {{ __('messages.Full Name') }} <span class="text-red-500">*</span>
                    </label>
                ...
                <div>
                    <label for="email" class="block text-sm font-medium text-gray-700 mb-2">
                        {{ __('messages.Email Address') }} <span class="text-red-500">*</span>
                    </label>
                ...
                <div>
                    <label for="phone" class="block text-sm font-medium text-gray-700 mb-2">
                        {{ __('messages.Phone Number') }} <span class="text-red-500">*</span>
                    </label>
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm font-medium text-gray-700 mb-2">
                        {{ __('messages.Confirm Password') }} <span class="text-red-500">*</span>
                    </label>
        ...
        <div class="form-section p-6 mb-8">
            <div class="flex items-center mb-6">
                <div
                    class="w-10 h-10 bg-gradient-to-r from-green-500 to-teal-500 rounded-full flex items-center justify-center mr-4">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <h3 class="text-2xl font-bold text-gray-900">{{ __('messages.Location Information') }}</h3>
            </div>
        ...
        <div class="form-section p-6 mb-8">
            <div class="flex items-center mb-6">
                <div
                    class="w-10 h-10 bg-gradient-to-r from-purple-500 to-indigo-500 rounded-full flex items-center justify-center mr-4">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <h3 class="text-2xl font-bold text-gray-900">{{ __('messages.Professional Information') }}</h3>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label for="degree" class="block text-sm font-medium text-gray-700 mb-2">
                        {{ __('messages.Academic Degree') }} <span class="text-red-500">*</span>
                    </label>
                    <select id="degree" name="degree" required
                        class="form-input w-full px-4 py-3 focus:outline-none transition-all duration-300">
                        <option value="">{{ __('messages.Select Degree') }}</option>
                        ...
                        <option value="master" {{ old('degree') == 'master' ? 'selected' : '' }}>{{ __('messages.Master') }}
                        </option>
                        <option value="high_diploma" {{ old('degree') == 'high_diploma' ? 'selected' : '' }}>
                            {{ __('messages.High Diploma') }}
                        </option>
                        <option value="doctorate" {{ old('degree') == 'doctorate' ? 'selected' : '' }}>
                            {{ __('messages.Doctorate') }}
                        </option>
                    </select>
                    @error('degree')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            ...
            <div class="mt-6">
                <label for="description" class="block text-sm font-medium text-gray-700 mb-2">
                    {{ __('messages.Full Description About Yourself') }} <span class="text-red-500">*</span>
                </label>
            ...
            <div class="mt-6">
                <label for="experience" class="block text-sm font-medium text-gray-700 mb-2">
                    {{ __('messages.Work Experience') }} <span class="text-red-500">*</span>
                </label>
            ...
            <div class="mt-6">
                <label class="block text-sm font-medium text-gray-700 mb-2">
                    {{ __('messages.Subjects You Teach') }} <span class="text-red-500">*</span>
                </label>
                <div
                    class="grid grid-cols-2 md:grid-cols-3 gap-3 max-h-40 overflow-y-auto border border-gray-300 rounded-md p-3">
        ...
        <div class="form-section p-6 mb-8">
            <div class="flex items-center mb-6">
                <div
                    class="w-10 h-10 bg-gradient-to-r from-pink-500 to-rose-500 rounded-full flex items-center justify-center mr-4">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <h3 class="text-2xl font-bold text-gray-900">{{ __('messages.Contact & Social Media') }}</h3>
            </div>
        ...
        <div class="form-section p-8 mb-8 bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200">
            <div class="flex items-center mb-6">
                <div
                    class="w-12 h-12 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full flex items-center justify-center mr-4 animate-pulse">
                ...
                <h3 class="text-2xl font-bold text-blue-900">{{ __('messages.Subscription Information') }}</h3>
            </div>
            <p class="text-blue-700 mb-4">
                {{ __('messages.Annual subscription fee: 10 JD') }}
            </p>
