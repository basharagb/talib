...
@section('form-content')
    <form method="POST" action="{{ route('register.educational-center.store') }}" enctype="multipart/form-data"
        class="space-y-6">
        @csrf

        <!-- Basic Information -->
        <div class="bg-gray-50 p-6 rounded-lg">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">{{ __('messages.Basic Information') }}</h3>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Center Name -->
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-700 mb-2">
                        {{ __('messages.Center/Academy Name') }} <span class="text-red-500">*</span>
                    </label>
        ...
        <div class="bg-gray-50 p-6 rounded-lg">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">{{ __('messages.Location Information') }}</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label for="district" class="block text-sm font-medium text-gray-700 mb-2">
                        {{ __('messages.District/Area') }} <span class="text-red-500">*</span>
                    </label>
                ...
                <div>
                    <label for="location" class="block text-sm font-medium text-gray-700 mb-2">
                        {{ __('messages.Exact Location') }} <span class="text-red-500">*</span>
                    </label>
        ...
        <!-- Center Details -->
        <div class="bg-gray-50 p-6 rounded-lg">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">{{ __('messages.Center Details') }}</h3>

            <!-- Description -->
            <div class="mb-6">
                <label for="description" class="block text-sm font-medium text-gray-700 mb-2">
                    {{ __('messages.Full Description') }} <span class="text-red-500">*</span>
                </label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">
                    {{ __('messages.Subjects Taught') }} <span class="text-red-500">*</span>
                </label>
                <div
                    class="grid grid-cols-2 md:grid-cols-3 gap-3 max-h-48 overflow-y-auto border border-gray-300 rounded-lg p-4">
        ...
        <!-- Social Media Links -->
        <div class="bg-gray-50 p-6 rounded-lg">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">{{ __('messages.Social Media & Contact') }}</h3>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label for="facebook"
                        class="block text-sm font-medium text-gray-700 mb-2">{{ __('messages.Facebook') }}</label>
                ...
                <div>
                    <label for="twitter"
                        class="block text-sm font-medium text-gray-700 mb-2">{{ __('messages.Twitter') }}</label>
                ...
                <div>
                    <label for="instagram"
                        class="block text-sm font-medium text-gray-700 mb-2">{{ __('messages.Instagram') }}</label>
                ...
                <div>
                    <label for="whatsapp"
                        class="block text-sm font-medium text-gray-700 mb-2">{{ __('messages.WhatsApp') }}</label>
        ...
        <div class="flex justify-center pt-6">
            <button type="submit"
                ...
                {{ __('messages.Register & Proceed to Payment') }}
            </button>
        </form>
