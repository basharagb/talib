                    ...
                    <ul class="nav sidebar-menu flex-column" role="navigation">
                        ...
                        <li class="nav-item {{ request()->routeIs('register.*') ? 'menu-open' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('register.teacher') }}" class="nav-link {{ request()->routeIs('register.teacher') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>{{ __('messages.teacher') }}</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('register.educational-center') }}" class="nav-link {{ request()->routeIs('register.educational-center') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>{{ __('messages.educational_center') }}</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('register.school') }}" class="nav-link {{ request()->routeIs('register.school') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>{{ __('messages.school') }}</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('register.kindergarten') }}" class="nav-link {{ request()->routeIs('register.kindergarten') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>{{ __('messages.kindergarten') }}</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('register.nursery') }}" class="nav-link {{ request()->routeIs('register.nursery') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
